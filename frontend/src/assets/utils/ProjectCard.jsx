...
const Projectcard = ({ name, image, description, ts1, ts2, ts3, ts4, ts5, ts6, github_link, live_link }) => {
    return (
        // main container
        <div className='w-75 h-105 border border-purple-500/50 flex flex-col items-center rounded-xs hover:shadow-purple-400 hover:scale-110 bg-white dark:bg-black transition duration-200' id="projectcard">
